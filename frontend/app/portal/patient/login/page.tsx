...
const S: Record<string, React.CSSProperties> = {
  ...
  glow: { position: 'absolute', top: 0, left: 0, width: '100%', height: '400px', background: 'linear-gradient(to bottom, rgba(255,106,0,0.05), transparent)', pointerEvents: 'none' },
    ...
    <div style={S.page}>
      ...
      <div style={S.card}>
        ...
        <div style={S.links}>
          ...
          <Link href="/portal/patient/lookup" style={{ ...S.linkStyle, color: 'var(--q-orange)' }}>Look Up Account →</Link>
        </div>
