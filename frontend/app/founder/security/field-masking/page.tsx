  ...
  return (
    <div className="p-5 min-h-screen">
      <div className="hud-rail pb-3 mb-6">
        ...
        <h1 className="text-h2 font-bold text-zinc-100">Field Masking</h1>
        <p className="text-body text-zinc-500 mt-1">Configure PHI field masking rules by role and data classification.</p>
      </div>
