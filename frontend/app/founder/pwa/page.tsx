  ...
  return (
    <div className="p-5 space-y-6">
      <div>
        ...
        <h1 className="text-xl font-black uppercase tracking-wider text-[var(--color-text-primary)]">PWA & Mobile</h1>
        <p className="text-xs text-[var(--color-text-muted)] mt-0.5">Field app deployment · crew scheduling · device analytics</p>
      </div>
