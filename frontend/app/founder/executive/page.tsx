  ...
  return (
    <div className="p-5 space-y-6">
      <div>
        ...
        <h1 className="text-xl font-black uppercase tracking-wider text-[var(--color-text-primary)]">Executive Command</h1>
        <p className="text-xs text-[var(--color-text-muted)] mt-0.5">Daily AI brief · risk monitor · platform overview</p>
      </div>
