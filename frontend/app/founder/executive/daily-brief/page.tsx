  ...
  return (
    <div className="p-5 min-h-screen">
      <div className="hud-rail pb-3 mb-6">
        ...
        <h1 className="text-h2 font-bold text-zinc-100">Daily Brief</h1>
        <p className="text-body text-zinc-500 mt-1">AI-generated executive briefing covering operations, revenue, and compliance.</p>
      </div>
