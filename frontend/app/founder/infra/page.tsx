...
export default function InfraPage() {
  return (
    <div className="p-5 space-y-6">
      <div>
          <div className="text-micro font-bold uppercase tracking-[0.2em] text-orange-dim mb-1">DOMAIN 10 · INFRASTRUCTURE</div>
        <h1 className="text-xl font-black uppercase tracking-wider text-[var(--color-text-primary)]">Infrastructure</h1>
        <p className="text-xs text-[var(--color-text-muted)] mt-0.5">ECS · RDS · AI GPU · AWS costs · incident control</p>
      </div>
