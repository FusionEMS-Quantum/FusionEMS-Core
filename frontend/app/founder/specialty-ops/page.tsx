...
export default function FounderSpecialtyOpsPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6 p-6">
      ...
      {!summary ? (
        <div className="rounded border border-white/10 bg-white/[0.03] p-4 text-sm text-white/70">Loading specialty operations intelligence…</div>
      ) : (
        <>
            ...
            <div className="rounded border border-white/10 bg-white/[0.03] p-4">
              ...
              <div className="space-y-2">
                ...
                {missions.map((mission) => (
                  <div key={mission.id} className="rounded border border-white/10 bg-black/20 p-3">
