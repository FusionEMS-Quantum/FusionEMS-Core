    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between hud-rail pb-2">
        ...
        <button
          ...
          className="px-4 py-2 bg-brand-orange text-black text-sm font-semibold"
        >
      ...
      {showCreate && (
        <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }}
          ...
          <div className="flex items-center gap-4">
            ...
            <button onClick={handleCreateFlag} className="px-4 py-2 bg-brand-orange text-black text-sm font-semibold">Create Flag</button>
          </div>
        </motion.div>
      )}
