    ...
    <MarketingShell>
      <MarketingPageTemplate
        ...
        stats={[
          ...
          { label: 'Implementation Support', value: 'Executive-led', detail: 'Briefing and activation sequencing' },
        ...
        features={[
          ...
          { title: 'Executive Coordination', description: 'Align command staff around scope, timeline, and measurable outcomes from day one.', href: '/contact', ctaLabel: 'Request Briefing' },
        ]}
        actions={[
