...
export default function HospitalTransportLoginPage() {
  ...
  const onSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    setBusy(true);
    setTimeout(() => {
      router.push('/portal/cases?facility_type=hospital');
    }, 350);
  };

  return (
    <AccessShell
      title="Hospital TransportLink Login"
      subtitle="Hospital facility portal login for requesting and managing patient transport events."
    >
      <form className="space-y-3" onSubmit={onSubmit}>
        ...
        <div className="flex gap-2 flex-wrap pt-1">
          <button className="quantum-btn-primary" type="submit" disabled={busy}>
            {busy ? 'Entering…' : 'Enter Hospital Portal'}
          </button>
