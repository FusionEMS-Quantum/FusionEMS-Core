  ...
  return (
    <div className="min-h-screen bg-[#050505] text-zinc-100 flex flex-col relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none opacity-70"
        style={{
          backgroundImage:
            'radial-gradient(circle at 12% 10%, rgba(255,106,0,0.18), transparent 28%), radial-gradient(circle at 88% 12%, rgba(168,85,247,0.16), transparent 30%), linear-gradient(to right, rgba(255,255,255,0.02) 1px, transparent 1px), linear-gradient(to bottom, rgba(255,255,255,0.02) 1px, transparent 1px)',
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-10 relative z-10">
        <div className="w-full max-w-xl bg-[#0A0A0B] border border-border-default chamfer-12 p-6 space-y-4 shadow-elevation-2">
          ...
          <div>
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="text-micro uppercase tracking-[0.14em] text-status-active border border-status-active/40 bg-status-active/10 px-2 py-0.5 chamfer-4">Encrypted Session</span>
            </div>
