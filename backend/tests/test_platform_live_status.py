...
def _settings(**overrides: object) -> Settings:
    base: dict[str, object] = {
        ...
        "jwt_secret_key": "unit-ci-jwt-signing-key-do-not-deploy",
        "aws_region": "us-east-1",
        "system_tenant_id": "00000000-0000-0000-0000-000000000099",
        ...
        "stripe_events_table": "fusionems-ci-stripe-events",
        "lob_events_queue_url": "https://sqs.us-east-1.amazonaws.com/123456789012/lob-events",
        "lob_events_table": "fusionems-ci-lob-events",
        ...
        "statements_table": "fusionems-ci-statements",
        "tenants_table": "fusionems-ci-tenants",
