...
class AIAssistantService:
    ...
    async def generate_narrative(self, incident_data: dict) -> str:
        ...
        """
        logger.info("Generating AI Narrative for Incident")
        self._build_prompt("NARRATIVE_GENERATION", incident_data)
    ...
    async def generate_narrative_and_update_status(self, db_session, incident_id: str):
        ...
        # Generate
        await self.generate_narrative({}) # Pass real data
    ...
    async def _call_llm(self, prompt: str) -> dict:
        ...
        Returns structured AI explanation per Section 11.
        """
        import asyncio
        ...
        return {
            ...
            "severity": "HIGH",
            "business_context": "Operational impact pending assessment.",
            "confidence": 0.0,
        }
