...
For a Codespaces-friendly local runtime, use the repo root Docker Compose stack. The devcontainer now starts the required dependencies and helper scripts are available:
...
Before declaring deploy readiness, verify:
